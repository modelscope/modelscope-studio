...
subgraph "前端 NPM 包"
F_antd["@modelscope-studio/antd<br/>版本: 2.0.0-beta.1"]
F_antdx["@modelscope-studio/antdx<br/>版本: 2.0.0-beta.1"]
F_pro["@modelscope-studio/pro<br/>版本: 2.0.0-beta.1"]
F_base["@modelscope-studio/base<br/>版本: 2.0.0-beta.1"]
end
A_init --> A_antd
A_init --> A_antdx
A_init --> A_pro
...
- 版本与命名空间
  - 所有前端包均使用统一的版本号（2.0.0-beta.1），命名空间为 @modelscope-studio，便于发布与管理。
- 组件导出与分组
