...
**重要更新**：ModelScope Studio 2.0.0 已迁移到 Gradio 6.0 生态系统，支持版本范围为 >= 6.28.0。
...
> **⚠️ 说明：请使用 Gradio >= 6.28.0**
> 低于 6.28.0 的 Gradio 版本与当前组件库不兼容，请升级到 >= 6.28.0。详见 https://github.com/gradio-app/gradio/issues/13131
