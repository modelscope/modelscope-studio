...
- 版本号从 2.0.0-beta.0 更新为 2.0.0-beta.1
- Gradio 依赖版本要求更新为标准语法格式
- 更新变更日志以反映 2.0.0-beta.1 版本的特性
...
- **当前版本状态**
  - 后端 Python 包版本：2.0.0-beta.1
  - 前端与工作区根包版本：2.0.0-beta.1
- **版本号来源**
...
- **最新稳定/预发布版本**
  - 当前后端版本：2.0.0-beta.1
  - 前端与根包版本：2.0.0-beta.1
- **历史版本与重大里程碑**
  - 2.0.0-beta.1：新增 Ant Design 和 Ant Design X 的完整新功能
...
- **Python 兼容性**
  - Python 版本要求：>=3.8
  - Gradio 依赖范围：gradio>=6.0,<=6.8.0（当前 2.0.0-beta.1）
- **前后端版本对齐**
  - 根包与后端 Python 包版本均声明为 2.0.0-beta.1，建议保持一致
- **浏览器与运行环境**
  - 建议在主流浏览器中进行开发与测试
...
- **版本号一致性**
  - 后端 Python 包版本与根包版本保持一致（2.0.0-beta.1），有利于发布与回溯
- **依赖范围**
...
```mermaid
graph LR
V["版本号<br/>2.0.0-beta.1"] --> P["Python 包<br/>pyproject.toml"]
...
ModelScope Studio 当前处于 2.0.0-beta.1 预发布阶段，围绕 Gradio 6 与 Ant Design 6 的全面迁移带来显著的功能增强与稳定性提升。2.0.0-beta.1 版本新增了 Ant Design 和 Ant Design X 的完整新功能，进一步完善了组件生态。对于需要稳定性的生产环境，建议等待正式版发布；对于希望提前体验新特性的用户，可在充分评估变更日志与风险后选择 beta 版本。升级至 1.0 的关键在于在应用最外层包裹 Application 组件，并在必要时禁用 SSR 以适配 Hugging Face Space。
