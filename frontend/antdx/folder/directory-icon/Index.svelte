<script lang="ts">
  ...
  const AwaitedFolderDirectoryIcon = importComponent(
    () => import('./folder.directory-icon')
  );
...
{#await AwaitedFolderDirectoryIcon then FolderDirectoryIcon}
  <FolderDirectoryIcon
    style={proceedProps.elem_style}
    className={cls(
      proceedProps.elem_classes,
      'ms-gr-antdx-folder-directory-icon'
    )}
