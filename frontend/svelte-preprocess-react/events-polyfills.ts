/**
 * copied from https://github.com/microsoft/angular-react/blob/master/libs/core/src/lib/renderer/geteventlisteners.ts
 *
...
interface Element {
  ...
  eventListenerList: {
    [K in keyof ElementEventMap]?: Array<{
      type: K;
      listener: (this: Element, ev: ElementEventMap[K]) => any;
      useCapture: boolean | AddEventListenerOptions;
    }>;
  };
  getEventListeners<T extends keyof ElementEventMap>(
    type?: T
  ): T extends undefined
    ? Required<Element['eventListenerList']>
    : Required<Element['eventListenerList']>[T];
}
